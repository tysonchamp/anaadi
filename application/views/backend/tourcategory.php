      ...
      <form id="addcategory" action="<?=base_url('admin/Tourcategory/save_record')?>" method="POST">
          ...
          <div class="modal-body">
              <div class="col-md-10 mx-auto mb-2">
                ...
                <select name="category" id="addcategory" class="form-select">
              ...
              <div class="col-md-10 mx-auto">
                <label for="validationDefault03" class="form-label">Country / State</label>
                <input type="text" maxlength="100" autocomplete="off" class="form-control" name="country" id="validationDefault02" value="" required>
              </div>
          </div>

              ...
              <div class="card-body">
                ...
                <div class="col-lg-12 showalert">
                  ...
                  <form id="addtour" method="POST" enctype="multipart/form-data" action="<?=base_url('admin/Tours/save_record')?>">
                    ...
                    <!-- Basic Details -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Basic Details</div>
                    ...
                    <!-- Pricing & Group Size -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Pricing & Group Size</div>
                      <div class="card-body row g-3">
                        <div class="col-md-3">
                    ...
                    <!-- Locations -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Locations</div>
                      <div class="card-body row g-3">
                        <div class="col-md-6">
                    ...
                    <!-- Accommodation & Meals -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Accommodation & Meals</div>
                      <div class="card-body row g-3">
                        <div class="col-md-6">
                    ...
                    <!-- Tax & Charges -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Tax & Charges</div>
                      <div class="card-body row g-3">
                        <div class="col-md-6">
                    ...
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Inclusions & Exclusions</div>
                      <div class="card-body row g-3">
                        <div class="col-md-6">
                    ...
                    <!-- Validity & Dates -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Validity & Dates</div>
                      <div class="card-body row g-3">
                        <div class="col-md-6">
                    ...
                    <!-- Images & Description -->
                    <div class="card mb-4">
                      <div class="card-header bg-light fw-bold">Images & Description</div>
                      <div class="card-body row g-3">
                        <div class="col-md-12">

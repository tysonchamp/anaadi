					...
					<div class="newsletter-area">
						<div class="newsletter-top">
							<div class="row gy-4 align-items-center">
								<div class="col-lg-9">
									<h2 class="newsletter-title mb-0">Opportunity to escape, explore and experience all the exotic locales within India and across the world</h2>
								</div>
								<div class="col-lg-3">
							...
							<div class="widget widget_nav_menu footer-widget">
								...
								<div class="menu-all-pages-container">
									<ul class="menu">
										...
										<li><a href="<?=base_url('/Domestictours')?>">India</a></li>
										<li><a href="<?=base_url('/Internationaltours')?>">World</a></li>
										<li><a href="<?=base_url('/About')?>">Customize Tour</a></li>
										<li><a href="<?=base_url('/Terms')?>">Terms and Conditions</a></li>
										<li><a href="<?=base_url('/privecy')?>">Privacy policy </a></li>
										<li><a href="<?=base_url('/paymentpolicy')?>">Refund policy</a></li>
									</ul>
								</div>
							</div>
						</div>
